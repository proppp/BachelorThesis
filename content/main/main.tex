...
\begin{figure}[htp!]
    \centering
    \hspace*{-0.8cm}
    \includegraphics[scale = 1.9]{pics/images_medium_ma-2015-01259n_0006.png}
...
The derivative plot is generally  more helpful in identifying the occurring peaks, which are more pronounced with respect to the $\epsilon^{\prime\prime}$ plot (compare Figures \ref{300tpd}a vs. \ref{300tpd}b). This happens because of the removal of Ohmic conductivity, as discussed earlier. %todo maybe refer to discussion
...
\begin{figure}[!htb]%{.5\textwidth}
  \centering
  \includegraphics[scale = 0.46]{pics/combinedtau/Poly-TPD_combined_tau_max_vs_1000_over_T.pdf}
...
\begin{figure}[t]%{.5\textwidth}
  \centering
  \includegraphics[scale = 0.46]{pics/combinedtau/Poly-Bisphenol_combined_tau_max_vs_1000_over_T.pdf}
...
\begin{subfigure}[t]{.5\textwidth}
  \centering
  \includegraphics[scale = 0.46]{pics/misc/smartideatpd.pdf}
  \caption{Poly-TPD, 200nm film}
  \label{smartepsvsttpd}
\end{subfigure}%
\begin{subfigure}[t]{.5\textwidth}
  \centering
  \includegraphics[scale = 0.46]{pics/misc/smartideabisph.pdf}
  \caption{Poly-Bisphenol, 320nm film}
